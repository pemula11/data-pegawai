...
<div class="row">
      ...
      <div class="card my-4">
        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
          <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
            <h6 class="text-white text-capitalize ps-3">Table Golongan</h6>
          </div>
        </div>
            ...
            <table class="table align-items-center mb-0" id="myTable">
              <thead>
                <tr>
                  ...
                  <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Golongan</th>
                  ...
                  <td>
                    <div class="d-flex px-2 py-1">
                      ...
                      <div class="d-flex flex-column justify-content-center">
                        <h6 class="mb-0 text-sm"> {{ $data->nama_golongan }}</h6>
                        {{-- <p class="text-xs text-secondary mb-0">john@creative-tim.com</p> --}}
                      </div>
                    </div>
                  </td>
                  <td>
                    <p class="text-xs font-weight-bold mb-0">{{number_format($data->gaji_pokok, 2)}}</p>
                    {{-- <p class="text-xs text-secondary mb-0">Organization</p> --}}
                  </td>
                  <td class="align-middle text-center text-sm">
                    <p class="text-xs font-weight-bold mb-0">{{number_format($data->tunjangan_jabatan)}}</p>
                  </td>
                  
                  <td class="align-middle">
                    <a href="javascript:void(0)" id="btn-edit-golongan" data-id="{{ $data->id }}" data-original-title="Edit user">
  ...
  @include('dashboard.golongan.modal-add')
